...
interface Props {
    countries: Country[];
    userStoreAddres?: Partial<Address>;
};

const AddressForm = ({ countries, userStoreAddres = {} }: Props) => {

    const router = useRouter();

    const { handleSubmit, register, formState: { isValid }, reset } = useForm<FormIntupts>({
        defaultValues: {
            ...(userStoreAddres as any),
    ...
    const onSubmit = async(data: FormIntupts) => {
        // console.log({ data })
